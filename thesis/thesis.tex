...
\begin{figure}[H]
	...
	C.f. measurement data \todo{auf Messdatenbild verweisen!}}
\end{figure}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{(a) Heat flux measurement values $\eta^{\varPhi}(T_{ref})$ and (b) computed specific heat capacity $c_p(T)$ using eq. \cref{eq:c_p_formula_DIN} with distinct smearing effect for higher heat rates. \\
	C.f. $c_p(T)$ obtained by parameter estimation depicted in \cref{fig:5Gaussians_all_c_p,fig:FS_all_c_p,fig:FS_all_c_p_modHeatRate}.}
\end{figure}
