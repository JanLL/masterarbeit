...
An usual method elucidated in DIN 11357, using measurement data of heat flux differential scanning calorimetry (DSC), results in different outcomes $c_p^{\text{DIN}}(T)$ dependent on a measurement parameter, the heat rate. For higher heat rates, the peak of $c_p^{\text{DIN}}(T)$ is widened and its position shifts to higher temperatures. This is known as smearing problem since $c_p(T)$ is a material property and therefore independent from the heat rate.
...
Fundamentals about the heat capacity of polymers and experimental identification is are depicted in \cite{wunderlich_heat_capacity_polymers}.
The subject of thermal analysis of polymeric materials is extensively dealt with in \cite{wunderlich_thermal_analysis}. 
The measuring method of differential scanning calorimetry is in particular elucidated in \cite{Hoehne_DSC}, as well as on the remarked smearing problem. 
...
Altogether, there is research done in order to tackle the smearing problem. Although, not satisfactorily resolved yet. \\
...
\bibitem{wunderlich_heat_capacity_polymers}
	...
	Thermochimica Acta 300 (1997) 43-65
