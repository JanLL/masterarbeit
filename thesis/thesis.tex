...
This thesis approaches the problem of identifying the specific heat capacity $c_p$ of phase change materials (PCM). An usual method using measurement data of a heat flux differential scanning calorimetry (DSC) results in different outcomes dependent on a measurement parameter, the heat rate. 
