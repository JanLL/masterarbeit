...
In order to quantify how trustworthy the obtained estimated parameters are, a statistical analysis is applied. The results shown in the following part can be found including proofs in \cite{diss_bock} \cite{diss_koerkel}. \\
...
\begin{Theorem} .\\
	Let 
	\begin{equation}
		\theta_i := b \cdot \sqrt{\gamma(\alpha)} \cdot \sqrt{C_{ii}(x^*)} \qquad \text{for } i=1,...,n
	\end{equation}
...
\begin{figure}[H]
		\begin{subfigure}{0.32\textwidth}
			\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/fits_data/2017-12-08_22:22:31_407_L1=40_L3=0.1_N1=300_N3=50/2017-12-08_22:31:48_407_20Kmin_L1=40_L3=0,1/combined_img.png}
			\caption{}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
			\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/fits_data/2017-12-08_22:22:31_407_L1=40_L3=0.1_N1=300_N3=50/2017-12-08_22:39:19_407_10Kmin_L1=40_L3=0,1/combined_img.png}
			\caption{}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
			\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/fits_data/2017-12-08_22:22:31_407_L1=40_L3=0.1_N1=300_N3=50/2017-12-08_22:53:51_407_5Kmin_L1=40_L3=0,1/combined_img.png}
			\caption{}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
			\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/fits_data/2017-12-08_22:22:31_407_L1=40_L3=0.1_N1=300_N3=50/2017-12-08_22:59:44_407_2,5Kmin_L1=40_L3=0,1/combined_img.png}
			\caption{}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
			\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/fits_data/2017-12-08_22:22:31_407_L1=40_L3=0.1_N1=300_N3=50/2017-12-08_23:42:17_407_1,25Kmin_L1=40_L3=0,1/combined_img.png}
			\caption{}
		\end{subfigure}
		\begin{subfigure}{0.32\textwidth}
			\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/fits_data/2017-12-08_22:22:31_407_L1=40_L3=0.1_N1=300_N3=50/2017-12-08_23:47:19_407_0,6Kmin_L1=40_L3=0,1/combined_img.png}
			\caption{}
		\end{subfigure}
		\centering
		\begin{subfigure}{0.6\textwidth}
			\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/fits_data/2017-12-08_22:22:31_407_L1=40_L3=0.1_N1=300_N3=50/2017-12-08_23:53:54_407_0,3Kmin_L1=40_L3=0,1/combined_img.png}
			\caption{}
		\end{subfigure}
\end{figure}
...
Although the observed difference is quite small, with increasing time the shift in temperature will accumulate more and more.
Further this could be a reason for the observed shift in the obtained $c_p(T)$ in the previous sections.
This is why we perform now the parameter estimation again with the modified heat rate $<\beta_{meas}>$ stated in table \ref{tab:mod_heat_rate}.
...
\begin{table}[H]
	\centering
	\begin{tabular}{| c | c | c |} \hline 
		$\beta \ [K/min]$ & $<\beta_{meas}> \ [K/min]$ & $\sigma_{\beta_{meas}} \ [K/min]$ \\ \hline
		$20$ & $19.97$ & $0.033$ \\
		$10$ & $9.98$ & $0.019$ \\
		$5$ & $4.991$ & $0.0095$ \\
		$2.5$ & $2.4956$ & $0.0040$ \\
	...
	\end{tabular}
	\caption{Heat rates' mean value $<\beta_{meas}>$ obtained as in fig. \ref{fig:heat_rate_measurement} and corresponding standard deviation $\sigma_{\beta_{meas}}$ for all measurements.}
