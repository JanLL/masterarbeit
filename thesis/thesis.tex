...
The results after optimizing are shown in Fig. \ref{fig:NURBS_results}.
...
\begin{figure}[H]
	\begin{subfigure}{0.49\textwidth}
		...
		\caption{Specific heat capacity $c_p(T)$ obtained by parameter estimation.}
		\label{fig:NURBS_c_p}
	\end{subfigure}
	\begin{subfigure}{0.49\textwidth}
		\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/thesis/images/NURBS_heat_flux.png}
		\caption{Heat flux into PCM $\varPhi_q^{pcm,in}$ measurement values (dashed red), simulation (blue) and corresponding residuum (yellow).}
		\label{fig:NURBS_heat_flux}
	\end{subfigure}
	\begin{subfigure}{0.49\textwidth}
		\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/thesis/images/NURBS_jac.png}
		\caption{Optimization Jacobian $J_1(p_{c_p})$.}
		\label{fig:NURBS_jac}
	\end{subfigure}
	\hspace{1cm}
	\begin{subfigure}{0.49\textwidth}
		\includegraphics[width=1.\textwidth]{/home/argo/masterarbeit/thesis/images/NURBS_jac_zoom.png}
		\caption{Zoomed in view of Optimization Jacobian $J_1(p_{c_p})$.}
