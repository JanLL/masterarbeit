...
Finally the Gauss Newton optimization process has been examined, depicted in Fig. \ref{fig:optimization_progress_FS} for all heat rates. In the following the used norm will always refer to the euclidean norm $|| \cdot ||_2$.


Algorithm \ref{alg:Gauss_Newton_unconstrained} shows ...
