...
which can be solved analytically. The first step is a separation ansatz of the solution function $T(x,t)$ with $\Gamma(x,t)$ and $\bar{T}(x,t)$ satisfying the boundary conditions:
