...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Parameters and error for all heat rates $\beta$ from statistical analysis using error of probability $\alpha=0.05$. One Gaussian consist of three parameters (c.f. section \ref{sec:parametrization_Gausse}): top: amplitude $A_i$, middle: variance $var_i$, bottom: offset in temperature $T_{offset_i}$ \\
...
\begin{table}[H]
	...
	\begin{tabular}{| c | c | c | c | c | c | c |} \hline
		...
		$1.25$ & & & & & & \\
		$0.6$ & & & & & & \\
		$0.3$ & $40.3 \pm 3.4\%$ & $3.69 \pm 4.4\%$ & $0.51 \pm 8.4\%$ & $130.75 \pm 0.078\%$ & ---$^*$ & $1.94 \pm 12.6\%$ \\ \hline
	\end{tabular}
	\caption{\todo{Rest eintragen,momentan Werte von $2017-12-20_02:01:34$ aber offenbar identisch bei versch. Abbruchkriterien weil sich eh praktisch nichts mehr aendert.}}
