...
From here on we used the numerical integrator DAESOL-II within the SolvIND Suite. The relative error comparing integration tolerances $10^{-7}$ and $10^{-8}$  is shown in Fig. \ref{fig:integration_tolerance_error}.
...
\subsection{Parameter estimation with measurement data modified heat rate}
