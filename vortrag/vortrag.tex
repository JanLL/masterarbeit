...
\frame{
	...
	\begin{textblock}{14}(1,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_22:45:49_407_20Kmin_L1=50_L3=0,1/c_p(T).png}
	\end{textblock}
	
	\begin{textblock}{14}(8,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_22:45:49_407_20Kmin_L1=50_L3=0,1/q_pcm_in(T_ref).png}
	\end{textblock}	
}
...
\frame{
	...
	\begin{textblock}{14}(1,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_22:51:25_407_10Kmin_L1=50_L3=0,1/c_p(T).png}
	\end{textblock}
	
	\begin{textblock}{14}(8,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_22:51:25_407_10Kmin_L1=50_L3=0,1/q_pcm_in(T_ref).png}
	\end{textblock}	
}
...
\frame{
	...
	\begin{textblock}{14}(1,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_22:57:27_407_5Kmin_L1=50_L3=0,1/c_p(T).png}
	\end{textblock}
	
	\begin{textblock}{14}(8,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_22:57:27_407_5Kmin_L1=50_L3=0,1/q_pcm_in(T_ref).png}
	\end{textblock}	
}
...
\frame{
	...
	\begin{textblock}{14}(1,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_23:26:52_407_0,3Kmin_L1=50_L3=0,1/c_p(T).png}
	\end{textblock}
	
	\begin{textblock}{14}(8,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_23:26:52_407_0,3Kmin_L1=50_L3=0,1/q_pcm_in(T_ref).png}
	\end{textblock}	
}
...
\frame{
	...
	\begin{textblock}{14}(1,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_22:45:49_407_20Kmin_L1=50_L3=0,1/c_p_all(T).png}
	\end{textblock}
	
	\begin{textblock}{14}(8,6)
		\includegraphics[width=0.5\textwidth]{/home/argo/masterarbeit/fits_data/2017-10-15_22:45:49_407_20Kmin_L1=50_L3=0,1/c_p_all_zoom(T).png}
	\end{textblock}	
}
