...
%		\begin{bmatrix}
%		\beta \\
%		\frac{\lambda^{\text{PCM}}}{\rho^{\text{PCM}} \ c_p^{\text{PCM}}(T^1) } \cdot \frac{T^{0} - 2 T^{1} + T{2}}{\Delta x_{\text{Ag}}^2} \\
%		\vdots \\
%		\frac{\lambda^{\text{PCM}}}{\rho^{\text{PCM}} \ c_p^{\text{PCM}}(T^{N_1 - 2}) } \cdot \frac{T^{N_1-3} - 2 T^{N_1-2} + T{N_1-1}}{\Delta x_{\text{Ag}}^2} \\
...
%		\frac{\lambda^{\text{Ag}}}{\rho^{\text{Ag}} \ c_p^{\text{Ag}}} \cdot \frac{T^{N_1-1} - 2 T^{N_1} + T{N_1+1}}{\Delta x_{\text{PCM}}^2} \\
%		\vdots \\
%		\frac{\lambda^{\text{Ag}}}{\rho^{\text{Ag}} \ c_p^{\text{Ag}}} \cdot \frac{T^{N_1+N_3-3} - 2 T^{N_1+N_3-2} + T{N_1+N_3-1}}{\Delta x_{\text{PCM}}^2} \\
%		\frac{\lambda^{\text{Ag}}}{\rho^{\text{Ag}} \ c_p^{\text{Ag}}} \cdot \frac{T^{N_1+N_3-2} - T^{N_1+N_3-1}}{\Delta x_{\text{PCM}}^2}
%		\end{bmatrix}
%	\end{align*}
%
%	\end{textblock}
